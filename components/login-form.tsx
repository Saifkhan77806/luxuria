...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6 ", className)} {...props}>
      <Card className="overflow-hidden relative text-white p-0 bg-transparent">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className=" text-purple-600 ml-auto text-sm underline-offset-2 hover:underline"
                  >
              ...
              <div className="text-center text-white text-sm">
                ...
                <Link href="/register" className=" text-purple-600 underline underline-offset-4">
                  Sign up
                </Link>
              </div>
            </div>
